...
export const INITIAL_SETTINGS: SiteSettings = {
  ...
  history: [
    { year: '2024년 1월 1일', text: '우리노동조합 디지털 혁신 선포 및 홈페이지 개편' },
    { year: '2015년 5월 10일', text: '전국 단위 노동 환경 실태 조사 실시' },
    { year: '2005년 3월 20일', text: '산별 노동조합 체제 전환' },
    { year: '1990년 12월 29일', text: '우리노동조합 창립 선언' }
  ],
  offices: [
    {
      id: 'jinkwan',
